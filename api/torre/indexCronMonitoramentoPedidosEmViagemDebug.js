...
sleep(3000)
console.log('Iniciando execução Pedidos em Viagem... ')
monitoramentoServico.monitorarPedidosEmViagem().then((retorno) => console.log('Fim da execução Pedidos em Viagem...', retorno)).catch((e) => console.log(e))
